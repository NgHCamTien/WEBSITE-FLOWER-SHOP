...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      {/* Trang trí: Một vệt màu hồng loang nhẹ ở góc nếu muốn (tùy chọn) */}
